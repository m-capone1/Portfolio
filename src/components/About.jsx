    ...
    return (
        <section ref={myStory} className="flex flex-col mx-6 md:mx-8 lg:mx-16 xl:mx-24">
            ...
            {readMore && (<div className="text-lg text-white-100">
                <div className="py-2">
                    My journey into programming began during a mandatory introductory C++ course for my Mechanical Engineering degree. I didn’t expect much from it since coding wasn’t something I thought would become important in my life or my career. I vividly remember feeling frustrated that I couldn't solve one of the weekly programming projects. No matter how much time I spent on it, I couldn’t figure it out. It was frustrating me so much that I seriously considered giving up. I was convinced that maybe programming just wasn’t for me.
                </div>
                <div className="py-2">
                <strong className='text-secondAccent'>
                    When I finally cracked the problem - something clicked for me.</strong> I think that the first problem taught me a lot about perseverance, hard work, and the satisfaction that follows solving a complex issue. I then began to see programming differently. I found myself seeking out new challenges, excited by solving complex problems. 
                    Programming quickly became more than just a requirement for my degree - it became a passion. I get a thrill from problem solving and I welcome new challenges. It motivates me to be a better engineer and to learn more every day.
                </div>
                <div className="py-2">
                    Although I have a background and expertise in Mechanical Engineering, I use programming as a tool to streamline processes and it is my long-term goal to fully transition into the software engineering industry. The constant learning process and problem-solving required in programming motivate me to push the 
